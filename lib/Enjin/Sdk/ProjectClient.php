...
/**
 * Project Client - Client for using the project schema
 * 
 * @copyright (c) 2021, Enjin Pte. Ltd.
 * @author    Mark Jivko, https://markjivko.com
 * @license   Apache License v2.0, https://www.apache.org/licenses/LICENSE-2.0.txt
 */
class ProjectClient extends Schema\Project implements Interfaces\Client {

    // Import the client traits
    use Schema\Client;
    
    /**
     * Constructs a project client with the targeted settings
     *
